...
typedef GPIOx_MODE_t GPIOx_PUPDR_t;
typedef GPIOx_ODR_t GPIOx_IDR_t;
typedef enum {
	row1,row2,row3,row4
}rows_t;
void init(RCC_AHB1ENR_t volatile *const pClkCtrlReg,GPIOx_PUPDR_t volatile *const pGpioxPUPDR, GPIOx_MODE_t volatile *const pGpioxMode);
